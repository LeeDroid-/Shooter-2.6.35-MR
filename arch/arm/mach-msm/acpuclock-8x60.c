...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[26] = {1782000,  1, 0x21, 1375000, 1400000, 4}
#endif
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
  ...
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(26), 1400000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(26), 1425000, 0x03006000},
#endif
  { {0, 0}, 0 },
};
